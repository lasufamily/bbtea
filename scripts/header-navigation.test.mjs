...
test('main navigation only includes Directory, Bubble Tea, and Coffee', async () => {
  ...
  assert.doesNotMatch(navLinksSource, /Towns|Malls|Menus|Drinks|Brands|Blog|Search/);
});
